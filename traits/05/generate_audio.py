...
ZH_LINES = [
    ...
    "平衡木的前進、",
    "盪鞦韆也能穩當的爬上攀登架、",
    "另一方面在手作DIY的活動中也能運用材料和工具、",
    "做成像模像樣的作品。"
]

EN_LINES = [
    "By this age, children's movements are more coordinated and stable.",
    "They can take on all kinds of active play equipment —",
    "walking forward on a balance beam,",
    "swinging, and climbing up the jungle gym with confidence.",
    "In hands-on DIY activities they can use materials and tools,",
    "and produce genuinely impressive works."
]
