...
EN_LINES = [
    "Children are in the early stages of socialization.",
    "They need to learn how to get along with peers.",
    "Encourage them to play with other children,",
    "and arrange suitable playmates for them,",
    "like children of relatives, friends, or neighbors.",
    "Through friendliness, they build confidence in being with others."
]
