...
EN_LINES = [
    "Create chances for your child to express their opinions —",
    "like talking about cartoon characters and plots,",
    "or including them in family discussions.",
    "Within reason, accept their ideas,",
    "building confidence in their own voice,",
    "so they dare to express themselves,",
    "and engage in real discussion with others."
]
