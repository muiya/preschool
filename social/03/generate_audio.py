...
EN_LINES = [
    "When a child is hurt or facing a problem,",
    "don't rush in to intervene or shield them,",
    "so they don't grow dependent,",
    "unwilling to face problems on their own,",
    "becoming withdrawn and weak."
]
