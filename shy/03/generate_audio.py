...
ZH_LINES = [
    ...
    "或對環境、人、事、物的看法、",
    "最後請多擁抱你的孩子、",
    "一個常被父母擁抱的孩子對人際交往也較具有信心。"
]

EN_LINES = [
    "Parents must allow their children to express freely.",
    "For example, what they dreamed last night,",
    "or letting them express joy, anger, sadness, and happiness.",
    "Guide them to voice their feelings,",
    "or their views on the world, people, and events.",
    "And finally, please hug your child often.",
    "A child who is often embraced by their parents has more confidence in social relationships."
]
