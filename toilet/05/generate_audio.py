...
EN_LINES = [
    "Instructions should be short and easy for the child to understand.",
    "Choose a place where training will not be interrupted,",
    "to avoid distraction.",
    "Teach your child to sit quietly on the potty,",
    "in a relaxed way,",
    "then repeatedly practice walking to the potty chair.",
    "Beforehand, teach them to pull their pants down and up."
]
