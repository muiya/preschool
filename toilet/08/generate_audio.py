...
EN_LINES = [
    "Make learning fun.",
    "Let the child see training as a game,",
    "and whenever they do well",
    "and make progress toward the goal,",
    "give them a reward immediately.",
    "Praise them often, and praise them warmly."
]
