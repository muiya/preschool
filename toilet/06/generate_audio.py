...
EN_LINES = [
    ...
    "and let your child imitate the steps.",
    "Have them watch and copy the actions,",
    "and encourage them to teach the doll how to use the toilet."
]
