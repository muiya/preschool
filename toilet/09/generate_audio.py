...
EN_LINES = [
    "If training goes on too long,",
    "the child will grow bored and tired.",
    "Let them take a short nap,",
    "but the nap should be shorter than their usual one."
]
