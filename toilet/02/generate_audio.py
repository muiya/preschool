...
ZH_LINES = [
    ...
    "家長要重複地讓孩子練習不同的大小便動作、",
    "直到孩子完全學會為止。",
    "記住、要不停的誇他、鼓勵他、耐心的訓練他、",
    "不用多久、",
    "家長就會微笑著驗收成果了。"
]

EN_LINES = [
    "Two- to three-year-olds struggle with complex instructions,",
    "so parents at every moment",
    "should teach just one manageable step at a time.",
    "From the start of training until completion,",
    "you absolutely must avoid anger, scolding, or physical punishment.",
    "Have your child repeatedly practice the different toileting steps,",
    "until they fully master them.",
    "Remember — keep praising, encouraging, training patiently,",
    "and before long",
    "parents will be smiling at the results."
]
