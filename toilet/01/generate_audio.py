...
EN_LINES = [
    "When guiding your child,",
    "use your expressions, voice, and gestures at every moment",
    "to praise the parts they get right.",
    "Say \"right!\" or \"well done!\"",
    "so the child feels strong motivation",
    "to keep moving in the direction you want them to learn."
]
