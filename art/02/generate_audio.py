...
EN_LINES = [
    "Since childhood education is such a defining period in life,",
    "we should use plenty of hands-on DIY activities",
    "to awaken a child's mind and potential,",
    "and enrich their inner world —",
    "helping them become people who can think, judge, and act.",
    "Effective and proper early education",
    "raises children who are healthy, intelligent, and joyful,",
    "who know how to cherish and give thanks, and who think rationally.",
    "And at the same time, it lays the foundation for their future success."
]
