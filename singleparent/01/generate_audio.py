...
ZH_LINES = [
    ...
    "在性別教育上會有所缺失、",
    "對小孩的示範作用較不完全、",
    "所以單親家庭中的父母對孩子的教育需要特別注意。"
]

EN_LINES = [
    "We often hear scholars say",
    "that education from age zero to six determines a child's whole life.",
    "This is true for typical families,",
    "and single-parent families need to take it even more seriously.",
    "Because a single-parent household is always missing one member,",
    "gender education inevitably has gaps,",
    "and role modeling is less complete.",
    "So single parents must pay extra attention to their child's upbringing."
]
