...
EN_LINES = [
    "Single-parent families, being structurally incomplete,",
    "may have gaps in their children's education,",
    "but this is not an absolute.",
    "What truly matters is whether the parent is mentally healthy.",
    "If the parent is psychologically sound,",
    "they will surely find ways to compensate for any gaps,",
    "and raise a healthy child.",
    "On the other hand,",
    "even a two-parent family with all members present",
    "will, if the parents are mentally unwell,",
    "still raise an unhealthy next generation.",
    "This is the correct perspective everyone needs to hold."
]
