...
EN_LINES = [
    "Whether to start school early",
    "must be decided based on the child's best interests,",
    "not on the parent's preferences.",
    "If, once your child passes the assessment,",
    "the satisfaction you feel outweighs their own,",
    "that could be a warning sign",
    "telling you to examine your own ego,",
    "because the child themselves is not ready to leave their current state."
]
