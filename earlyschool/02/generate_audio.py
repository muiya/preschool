...
EN_LINES = [
    "Whether or not your child passes any assessment,",
    "and whether or not you choose early enrollment,",
    "teaching basic life skills is absolutely essential.",
    "Being able to say when they feel unwell,",
    "use a water dispenser, go to the toilet alone,",
    "make a phone call, and play simple games,",
    "as well as recognize the way from home to school —",
    "these daily-life habits",
    "matter far more to a child about to enter elementary school."
]
