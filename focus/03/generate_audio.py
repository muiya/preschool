...
EN_LINES = [
    "For active play, teach your child somersaults,",
    "bouncing balls, standing on one foot, jumping on a trampoline —",
    "all are extremely beneficial for children."
]
