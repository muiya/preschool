...
EN_LINES = [
    "When a child is focused on something,",
    "parents must never casually interrupt or disturb them,",
    "or pull them off-task to do something else,",
    "or nag constantly at their side,",
