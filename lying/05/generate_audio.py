...
EN_LINES = [
    "When parents find out their child has been lying,",
    "they should encourage the child to share what they really think,",
    "and listen patiently,",
    "to build the courage to tell the truth."
]
