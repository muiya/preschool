...
EN_LINES = [
    "The lies children tell are often the dreams and wishes they hope to fulfill,",
    "not attempts to hide bad behavior or bad thoughts.",
    "For example, a child said to his classmate,",
    "\"Yesterday my parents took me to the zoo.\"",
    "When the father found out his son was lying,",
    "he got very angry and scolded him.",
    "But he overlooked the child's deep wish to visit the zoo."
]
