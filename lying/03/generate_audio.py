...
EN_LINES = [
    "Sometimes parents themselves lie,",
    "yet hope their children will not.",
    "That's a very difficult thing to ask.",
    "Children naturally imitate their parents' lying behavior,",
    "so parents must lead by example."
]
