...
EN_LINES = [
    "If a child makes up a lie because of a wish,",
    "parents should understand the motive behind the lie,",
    "and the truth it conceals.",
    "Take time to step into the inner world of your child."
]
