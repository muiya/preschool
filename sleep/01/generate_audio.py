...
ZH_LINES = [
    ...
    "偶爾家中有特殊事情、",
    "孩子會比較興奮、",
    "父母可在適當的情況下以輕鬆愉快的口吻提醒孩子。"
]

EN_LINES = [
    "Generally speaking, a relaxed mind falls asleep easily.",
    "When it's time for bed,",
    "parents should show a cheerful demeanor,",
    "take their little hand,",
    "and go to bed together amid smiles and laughter.",
    "Don't keep urging them,",
    "making them tense or even rebellious.",
    "Sometimes, when something special is happening at home,",
    "children get more excited,",
    "and parents can remind them gently and warmly at the right moment."
]
