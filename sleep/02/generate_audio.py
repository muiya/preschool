...
EN_LINES = [
    "Children love little bedtime rituals —",
    "listening to stories, humming a song,",
    "sipping water, or playing with a favorite toy,",
    "or hugging a beloved plush to bed.",
    "So at a set time each night,",
    "parents can begin helping with the bedtime routine,",
    "creating a warm and friendly atmosphere.",
    "Tuck them in snugly,",
    "turn on a small nightlight, and let them sleep peacefully."
]
