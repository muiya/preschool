...
EN_LINES = [
    "Children learn to speak through trial and error.",
    "If they pronounce a word wrong,",
    "for example saying \"shyao guo\" instead of \"shyao gou,\"",
    "don't scold them or force them to repeat it,",
    "so as not to dampen their interest in learning to speak.",
    "Parents can simply say the word correctly alongside them,",
    "so the child hears the right pronunciation.",
    "If the child imitates immediately, praise them right away,",
    "and if they don't, never scold them for it."
]
