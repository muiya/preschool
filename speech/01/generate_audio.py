...
EN_LINES = [
    "To help your child learn to speak,",
    "parents must never use being too busy as an excuse.",
    "In fact, just half an hour each day,",
    "playing with your child attentively and with heart,",
    "will certainly improve their speaking abilities.",
    "If there are any developmental concerns, see a doctor as soon as possible."
]
