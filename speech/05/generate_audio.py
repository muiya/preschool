...
EN_LINES = [
    "Start by teaching commonly used words from daily life.",
    "Draw from whatever is right around you,",
    "things your child already touches and sees,",
    "so they can apply what they learn in real life."
]
