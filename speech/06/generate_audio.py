...
EN_LINES = [
    ...
    "parents must listen attentively,",
    "being the kind of engaged listener",
    "that helps your child develop good listening habits.",
    "And always encourage your child to speak more."
]
