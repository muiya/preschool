...
ZH_LINES = [
    ...
    "開始會叫爸、媽等單字了、",
    "當父母的此時應避免再學他說兒語、",
    "而該用慢、簡單、清楚、正確的字詞和嬰兒說話。"
]

EN_LINES = [
    "After babies reach nine months,",
    "they start saying single words like \"mama\" and \"dada.\"",
    "At this stage, parents should stop using baby talk,",
    "and instead speak to them using slow, simple, clear, and correct words."
]
