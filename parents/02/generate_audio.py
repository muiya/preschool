...
EN_LINES = [
    "Don't be afraid to let children try and make mistakes.",
    "Animals often grow by learning through their mistakes,",
    "and humans are no exception.",
    "For generations, traditional parents have arranged everything for their children,",
    "trying to prevent any mistake,",
    "but this actually slows a child's growth.",
    "So when safety is not a concern,",
    "letting children try and fail from a young age",
