...
EN_LINES = [
    "Correct a child's behavior at the right time.",
    "As children grow,",
    "they will sometimes behave inappropriately.",
    "Throughout that growth,",
    "parents must observe attentively and consistently,",
    "and offer corrections at the right moments.",
    "Through careful and ongoing guidance,",
    "a child's mental development",
    "will see remarkable progress."
]
