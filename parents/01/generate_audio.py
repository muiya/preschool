...
EN_LINES = [
    ...
    "As the old saying goes, \"a child grows on its own without help,\"",
    "meaning no teaching or discipline is needed — they'll grow up by themselves.",
    "But this is simply not true.",
    "Beyond simply growing, children need goals,",
    "and reaching those goals requires continuous nudging and guidance.",
    "The duty of parents is precisely to guide their children,",
    "steering them in the right direction from an early age."
]
