...
EN_LINES = [
    "The child will notice mom's growing belly,",
    "or learn through conversation that a sibling is coming.",
    "Why not prepare them mentally, so they don't guess wildly?",
    "Parents can, in a gentle manner,",
    "personally share some facts,",
    "or let them touch mom's rounded belly.",
    "Tell them that when the little sibling is born,",
    "they'll be just as tiny as you were,",
    "they won't be able to walk,",
    "and won't be able to play with you right away."
]
