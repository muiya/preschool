...
EN_LINES = [
    "Keep rewards and consequences clear — agree on rules with your child.",
    "Keeping an agreement earns encouragement,",
    "and breaking it means losing certain privileges.",
    "For example, if toys are put away after play,",
    "they may be played with again or swapped for new ones.",
    "Otherwise, restrict access to toys or favored activities.",
    "Never cave just because you feel sorry for them."
]
