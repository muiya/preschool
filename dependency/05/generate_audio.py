...
EN_LINES = [
    ...
    "you gradually cultivate an independent personality in the child.",
    "And here, I sincerely urge young parents:",
    "building a child's daily habits",
    "must begin slowly in early childhood and develop over time.",
    "Experience can be gained",
    "from others' shared stories or from parenting books,",
    "and then tailored to the traits of your own child."
]
