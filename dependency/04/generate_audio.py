...
EN_LINES = [
    "At first, the child may wake in the middle of the night,",
    "and drift back to the parents' room half-asleep.",
    "If they agree to be carried back to their own room,",
    "parents should take them back right away.",
    "If the child refuses,",
    "wait until they're deeply asleep, and then carry them back."
]
