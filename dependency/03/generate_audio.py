...
ZH_LINES = [
    ...
    "讓孩子參與佈置和設計、",
    "無形中孩子就有一種期待的喜悅、",
    "也別忘了提醒孩子再過幾天就有自己的房間了、",
    "房間內有好多的動物陪他睡覺、",
    "那些動物都是你的好朋友。"
]

EN_LINES = [
    "Parents can put cards of the child's favorite animals on the walls,",
    "like little white rabbits, monkeys, giraffes,",
    "and even flowers, grass, and trees.",
    "You can also make a space for their preschool artwork.",
    "On the bed, place toys or dolls the child loves.",
    "Let the child take part in decorating and designing,",
    "and a quiet sense of excitement will grow in them.",
    "Also remind them that in just a few days, their own room will be ready,",
    "with so many animals to sleep beside them,",
    "\"All of these animals are your good friends.\""
]
