...
ZH_LINES = [
    "幼兒到兒童前期的孩子已逐漸由家庭的單純哺育環境下、",
    "走向托兒所、幼兒園等團體生活、",
    "所以除了教導孩子適應家庭中的人際關係之外、",
    "還要留意孩子的社會技巧、",
    "例如不可隨意攻訐別人、",
    "不能有太強烈的嫉妒和敵意、",
    "以便親切和氣的與所有孩童相處、",
...
EN_LINES = [
    "Children from toddlerhood into early childhood gradually move",
    "from the simple family setting into group life — daycare, preschool.",
    "So beyond helping them adjust to family relationships,",
    "we must also tend to a child's social skills.",
    "For instance, they must not casually attack others,",
    "nor harbor intense jealousy or hostility,",
    "so they can get along warmly with all children,",
    "and develop their social nature."
]
