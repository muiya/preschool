...
EN_LINES = [
    "Discipline often focuses only on outward behavior,",
    "like cleanliness habits or tidying belongings.",
    "Yet what matters most is building their sense of right and wrong, with clear rewards and consequences.",
    "Embracing and caressing a child,",
    "a warm and tender gaze,",
    "joyful body language —",
    "all give a child a feeling of complete happiness,",
