...
EN_LINES = [
    "Parents and caregivers must be consistent in their approach to discipline,",
    "with demands that are neither too strict nor too lenient.",
    "Not authoritarian, not permissive — but truly formative.",
    "Many parents err on the side of indulgence,",
    "or their own behavior swings with their mood,",
    "making rewards and punishments unpredictable.",
    "This leaves the child confused and lost,",
    "resulting in difficult behavior and a defiant temperament."
]
