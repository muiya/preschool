...
EN_LINES = [
    ...
    "A parent's conduct is what a child identifies with.",
    "Their behavior, like a recording, is imprinted on the child's heart.",
    "So a parent's words and actions leave a deep and lasting impact,",
