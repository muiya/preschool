...
EN_LINES = [
    "Walkers, tricycles, and bicycles",
    "hold an important place in motor development.",
    "Through the use of their legs,",
    "they get great opportunities for nerve, muscle, and bone development,",
    "along with building full-body balance.",
    "Children also imagine themselves as grown-ups,",
    "driving their own vehicles,",
    "and feel deeply satisfied inside."
]
