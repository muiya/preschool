...
EN_LINES = [
    "When babies begin learning to sit, crawl, stand, and walk,",
    "they need a clean and safe environment.",
    "Through movement, muscles and joints grow stronger,",
    "and a sense of body awareness develops.",
    "Dress them in light, comfortable clothes,",
    "so they can move freely and without restraint on the floor.",
    "You can even place toys around their play space,",
    "enticing them to reach or crawl toward them,",
    "giving them just the right amount of activity."
]
