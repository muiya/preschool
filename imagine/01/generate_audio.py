...
EN_LINES = [
    "Listen patiently to your child's story, complaint, or grievance,",
    "even when their words are sharp or urgent.",
    "As parents, we must not criticize them first,",
    "but listen with heartfelt concern,",
    "and then truly understand what they really mean."
]
