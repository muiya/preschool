...
ZH_LINES = [
    "建議家長可以提供藝術、民俗、宗教各方面的知識、",
    "來拓展孩童的心靈視野、",
    "激發孩童的創造潛能。"
]

EN_LINES = [
    "Parents are encouraged to share knowledge of art, folklore, and religion,",
    "to expand a child's spiritual perspective,",
